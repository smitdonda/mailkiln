 ...
 *
 * @module mailkiln/react/useMailKiln
 */
 ...
 * `useMailKiln()` to build their own layout get real autocomplete out of the
 * published `.d.ts`.
 *
 ...
 * because it calls hooks — it is part of `useMailKiln`, not a helper.
 *
